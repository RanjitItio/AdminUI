...
import CryptoSentTableEditModal from './CryptoSentEditModal';
...
export default function CryptoSentTable({headCells, rows, TableName, updateTransactionID, handleTransactionStatusUpdate, setStaus, status}) {
...
//   ]
  ...
  return (
    ...
    <CryptoSentTableEditModal open={open} handleClose={handleCryptoSentEditClose} handleTransactionStatusUpdate={handleTransactionStatusUpdate} setStaus={setStaus} status={status} />
