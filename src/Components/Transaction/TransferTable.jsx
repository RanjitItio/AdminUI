  ...
  return (
    <Box sx={{ width: '100%' }}>
        ...
        <Grid container spacing={2}>
            <Grid item xs={12} sm={6} md={2} style={{marginBottom: '20px'}}>
            <FormControl sx={{minWidth: 220, marginTop: '0px', marginLeft: '20px'}} >
            ...
            <Grid item xs={12} sm={6} md={3}>
              <TextField sx={{marginTop: '0px', marginLeft: '20px'}}  id="outlined-basic" label="Enter user name" variant="outlined" />
            </Grid>
            
            <Grid item xs={12} sm={12} md={3}  >
              <Button variant="contained" sx={{marginLeft: {xs: '90px', sm: '90px'}, marginBottom: {xs: '10px', sm: '10px'}, marginTop: '10px'}}>Filter</Button>
            </Grid>
