...
const NavContent = [
  ...
  { text: 'Transactions', subItems: [
    ...
    {text: 'Currency Exchange', icon: <PaymentsOutlinedIcon />, url: 'https://cssgradient.io/'},
    {text: 'Request Payments', icon: <CalculateOutlinedIcon />, url: 'https://cssgradient.io/'},
    {text: 'Merchant Payment', icon: <PaymentsOutlinedIcon />, url: 'https://cssgradient.io/'},
