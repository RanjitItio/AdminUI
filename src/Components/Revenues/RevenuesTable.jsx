...
export default function RevenuesTable({headCells, rows, TableName}) {
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left" padding="none">{row.percentage_charge}</TableCell>
                    <TableCell align="left">{row.fixed_charge}</TableCell>
